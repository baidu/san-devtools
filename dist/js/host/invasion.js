...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _injector = __webpack_require__(80);

	var _injector2 = _interopRequireDefault(_injector);

	var _hook = __webpack_require__(117);

	var _interchange = __webpack_require__(118);
...
/***/ (function(module, exports) {
	...
	exports.default = {
	    ...
	    storeEventNames: ['store-connected', 'store-dispatched', 'store-action-added'],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getDevtoolNS() {
	    ...
	    var global = window;
	    if (!global || !_lodash2.default.isObject(global[("__san_devtool__")])) {
	        return null;
	    }
	    return global[("__san_devtool__")];
	}

	function addStoreEventListeners() {
	    var sanDevtool = getDevtoolNS();
	    if (!sanDevtool || !_lodash2.default.isObject(sanDevtool.store)) {
	        return;
	    }

	    if (!_lodash2.default.isArray(sanDevtool.store.actions) || !_lodash2.default.isArray(sanDevtool.store.mutations) || !_lodash2.default.isObject(sanDevtool.store.stores)) {
	        return;
	    }
	    ...
	    try {
	            ...
	            sanDevtool.on(e, function () {
	                ...
	                switch (e) {
	                    case 'store-connected':
	                        var store = args[0].store;
	                        var componentClass = args[0].componentClass;
	                        store.connectedComponentClass = store.connectedComponentClass || [];
	        ...
	        for (var _iterator = (0, _getIterator3.default)(_constants2.default.storeEventNames), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            _loop();
	        }
	    } catch (err) {
	        _didIteratorError = true;
	...
	function addSanEventListeners() {
	    ...
	    try {
	        ...
	        for (var _iterator2 = (0, _getIterator3.default)(_constants2.default.sanEventNames), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            _loop2();
	        }
	    } catch (err) {
	...
	exports.default = {
	    ...
	    addStoreEventListeners: addStoreEventListeners
	};
